...
export const ProfileSettings = () => {
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (profileForm.img !== user?.img) {
        updateData.img = profileForm.img;
      }

      await axios.put(`/api/users/${user?._id}`, updateData);
      setMessage({ type: "success", text: "Profile updated successfully!" });
      
      // Refresh the page after a short delay to fetch updated user data
      setTimeout(() => {
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {/* Message */}
          {message && (
            <div className={`mx-8 mt-6 p-4 rounded-lg font-medium ${
              ...
              <div className="space-y-6">
                <div>
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="p-3 w-full border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-[#1dbf73] focus:border-transparent outline-none transition cursor-pointer"
                        >
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="mt-6 px-8 py-3 bg-[#1dbf73] text-white rounded-lg font-semibold shadow-lg hover:bg-[#19a463] transition-all transform hover:scale-105 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:transform-none"
                  >
                ...
                <div>
                  ...
                  <div className="max-w-md space-y-5">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="px-8 py-3 bg-[#1dbf73] text-white rounded-lg font-semibold shadow-lg hover:bg-[#19a463] transition-all transform hover:scale-105 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:transform-none"
                    >
